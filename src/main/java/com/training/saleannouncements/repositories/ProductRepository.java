...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    List<Product> findAllByCityContainingIgnoreCase(String city);

    List<Product> findAllByTitleContainingIgnoreCaseAndCityContainingIgnoreCase(String title, String city);
}
